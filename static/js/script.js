console.log(
  "%cCopyright © 2024 www.taodangcap.com",
...
document.addEventListener("DOMContentLoaded", function () {
  var themeState = getCookie("themeState") || "Light1";
  ...
  function changeTheme(theme) {
    if (theme == "Dark") {
      themeState = "Dark";
      changeSvg("#ffffff");
      hiv.src = "./static/img/svg/snake-Dark.svg";
...
*/
  switchCheckbox.addEventListener("change", function () {
    if (themeState == "Dark") {
      ...
      cuteToast({
        type: "success",
        message: "Change Theme V1 Active",
        timer: 2222,
      });
    } else if (themeState == "Light1") {
      changeTheme("Light2");
      cuteToast({
        type: "success",
        message: "Change Theme V2 Active",
        timer: 2222,
      });
    } else if (themeState == "Light2") {
      changeTheme("Dark");
      cuteToast({
        type: "success",
        message: "Change Theme Dark Active",
        timer: 2222,
      });
    }
  });
  if (themeState == "Light1") {
    cuteToast({
      type: "success",
  ...
  var center = document.getElementById("PageLoading-ws-center");
  setTimeout(function () {
    checkProjectItems();
...
leaf =
  "data:image/svg+xml;base64,";
maple =
  "data:image/svg+xml;base64,";
snow =
  "data:image/svg+xml;base64,";
user = "";
img.src = maple;
